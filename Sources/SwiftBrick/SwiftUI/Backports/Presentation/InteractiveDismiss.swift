...
public extension SwiftBrickWrapper where Wrapped: View {
    ...
    ///         @Environment(\.SwiftBrickWrapperDismiss) private var dismiss
    ///
    ///         var body: some View {
    ///             Form {
    ...
    /// tapping the button --- which calls ``EnvironmentValues/SwiftBrickWrapperDismiss``
    ...
    ///                 TermsOfService()
    ///                     .SwiftBrickWrapper.interactiveDismissDisabled(!areTermsAccepted)
    ///             }
    ///         }
    ///     }
    ///
    ...
    /// by calling the environment's ``EnvironmentValues/SwiftBrickWrapperDismiss`` action.
    ///
    ...
    func interactiveDismissDisabled(_ isDisabled: Bool = true) -> some View {
        #if os(iOS)
        wrapped.background(SwiftBrickWrapper<Any>.Representable(isModal: isDisabled, onAttempt: nil))
        #else
        wrapped
        #endif
    }
    ...
    func interactiveDismissDisabled(_ isDisabled: Bool = true, onAttempt: @escaping () -> Void) -> some View {
        #if os(iOS)
        wrapped.background(SwiftBrickWrapper<Any>.Representable(isModal: isDisabled, onAttempt: onAttempt))
        #else
        wrapped
        #endif
    }
